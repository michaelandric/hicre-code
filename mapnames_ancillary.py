# -*- coding: utf-8 -*-
"""
Created on Mon May 18 12:35:30 2015
...
lv2 = []
for b in blindLV:
    lv1.append(b.split()[1])
    lv2.append(b.split()[2])

lv1 = np.array(lv1, dtype=np.float64)
lv2 = np.array(lv2, dtype=np.float64)

lv_table = np.column_stack([ctnames, lv1, lv2])
lv_dict = dict(zip(ctnames, zip(lv1, lv2)))
