...
if __name__ == '__main__':
    ...
    for n in xrange(niter):
        ...
        infile1 = 'null_tree_highest/%s_dens0.1_tree.graph10.iter%d.tree_highest' % ('Null_CB', n)
        ...
        infile2 = 'null_tree_highest/%s_dens0.1_tree.graph10.iter%d.tree_highest' % ('Null_CB', n)
